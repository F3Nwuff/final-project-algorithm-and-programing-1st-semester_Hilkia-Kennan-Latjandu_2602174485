...
bp = Piece('b', 'p', 'images/B_Pawn2.png')
wp = Piece('w', 'p', 'images/W_Pawn2.png')
bk = Piece('b', 'k', 'images/B_King2.png')
wk = Piece('w', 'k', 'images/W_King2.png')
br = Piece('b', 'r', 'images/B_Rook2.png')
wr = Piece('w', 'r', 'images/W_Rook2.png')
bb = Piece('b', 'b', 'images/B_Bishop2.png')
wb = Piece('w', 'b', 'images/W_Bishop2.png')
bq = Piece('b', 'q', 'images/B_Queen2.png')
wq = Piece('w', 'q', 'images/W_Queen2.png')
bkn = Piece('b', 'kn', 'images/B_Knight2.png')
wkn = Piece('w', 'kn', 'images/W_Knight2.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'images/B_Rook2.png'), Piece('b', 'kn', 'images/B_Knight2.png'), Piece('b', 'b', 'images/B_Bishop2.png'),
               Piece('b', 'q', 'images/B_Queen2.png'), Piece('b', 'k', 'images/B_King2.png'), Piece('b', 'b', 'images/B_Bishop2.png'),
               Piece('b', 'kn', 'images/B_Knight2.png'), Piece('b', 'r', 'images/B_Rook2.png')]

    board[7] = [Piece('w', 'r', 'images/W_Rook2.png'), Piece('w', 'kn', 'images/W_Knight2.png'), Piece('w', 'b', 'images/W_Bishop2.png'),
               Piece('w', 'q', 'images/W_Queen2.png'), Piece('w', 'k', 'images/W_King2.png'), Piece('w', 'b', 'images/W_Bishop2.png'),
               Piece('w', 'kn', 'images/W_Knight2.png'), Piece('w', 'r', 'images/W_Rook2.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'images/B_Pawn2.png')
        board[6][i] = Piece('w', 'p', 'images/W_Pawn2.png')
    return board
...
logo = pygame.image.load("images/logo-chess.png")
pygame.display.set_icon(logo)
screen = pygame.display.set_mode((540, 540))
pygame.display.set_caption("ヒルキア の カオスチェス")
...
def main(WIN, WIDTH):
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            # Handle user input to make moves
            # ...
